...
const main = err => {
  ...
  if (window._wpLoadBlockEditor) {
    window._wpLoadBlockEditor.then(() => {
      (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.unregisterBlockStyle)("core/image", ["rounded"]); // Register blocks in App/block_styles as CSS can be autoloaded from there.
    });
  }
};
/**
